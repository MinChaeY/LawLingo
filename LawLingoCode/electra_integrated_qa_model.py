#학습시킨 모델을 사용하여 qa로 질의응답 시스템을 제작하기 위해 필요한 클래스를 정의한 코드
...
class QuestionAnsweringForIntegratedElectra(ElectraPreTrainedModel):
    ...
    def __init__(self, config=None):
        ...
        self.embedding_answer_span = electra.embeddings
        self.embedding_yesno = electra.embeddings
        self.embedding_multi_choice = electra.embeddings
